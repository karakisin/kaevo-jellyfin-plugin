...
- The exact build was installed on the paired physical iPhone SE and the installed-app inventory reconfirmed bundle `com.sumagang.kaevo`, version `4.3`, and bundle version `161`. It was not launched; the primary iPhone 14 Pro Max was not used.
