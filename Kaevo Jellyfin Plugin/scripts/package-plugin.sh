...
{
  "category": "General",
  "changelog": "Adds opt-in Jellyfin plugin integrations and bounded Intro Skipper media-segment support for exact Skip Intro and Skip Recap playback prompts.",
