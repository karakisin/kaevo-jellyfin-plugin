...
{
  "category": "General",
  "changelog": "Restores Guest Pass cover artwork and allows AVPlayer's authorized HLS manifest probe to complete immediately so protected playback can start instead of timing out on a black screen.",
