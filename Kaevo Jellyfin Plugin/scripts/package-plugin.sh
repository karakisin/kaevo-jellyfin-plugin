...
{
  "category": "General",
  "changelog": "Adds optional exact linked-account cleanup during Kaevo account deletion, deleting Seerr first and Jellyfin second with immutable-ID absence verification.",
