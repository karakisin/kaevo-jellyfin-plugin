...
{
  "category": "General",
  "changelog": "Reloads Jellyfin's saved plugin configuration before signed heartbeats and remote commands so two-way profile deletion status and enforcement update without a server restart.",
