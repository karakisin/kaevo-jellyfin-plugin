...
{
  "category": "General",
  "changelog": "Carries exact bounded Jellyfin trickplay metadata through Kaevo Cloud so remote playback can display grant-authorized sprite previews without changing transport or controls.",
