...
{
  "category": "General",
  "changelog": "Fixes Pairing V3 repair by selecting the exact pinned QA or Production authorization trust and matching Cloud endpoint from the signed authorization.",
